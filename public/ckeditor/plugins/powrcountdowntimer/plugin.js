...
CKEDITOR.plugins.add( 'powrcountdowntimer', {
  icons: 'countdowntimer',
  init: function( editor ) {
    editor.ui.addButton( 'countdowntimer', {
      label: 'Insert POWr Countdown Timer',
      command: 'insertpowrcountdowntimer',
      toolbar: 'insert'
    });
    editor.addCommand("insertpowrcountdowntimer", { // create named command
      exec: function(editor) {
        window.addPowrPlugin(editor, 'countdown-timer');
      }
    });
